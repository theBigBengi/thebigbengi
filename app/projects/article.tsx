  ...
  return (
    <Link href={`/projects/${project.slug}`}>
      <article className='p-4 md:p-8'>
        ...
        <h2 className='z-20 text-xl text-zinc-700 dark:text-zinc-200 font-medium duration-1000 lg:text-3xl  group-hover:text-black dark:group-hover:text-white font-display'>
          {project.title}
        </h2>
