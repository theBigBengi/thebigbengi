...
export default function Home() {
  return (
    <div className='flex flex-col items-center justify-center w-screen h-screen overflow-hidden dark:bg-gradient-to-tl from-black via-zinc-600/20 to-black'>
      ...
      <div className='my-16 text-center animate-fade-in'>
        <h2 className='text-sm text-zinc-500 '>Dynamic Full Stack Engineer</h2>
      </div>
    </div>
  );
}
