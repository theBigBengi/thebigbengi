...
[Supabase][https://supabase.com/] to authenticate and authorize your users.

## Database

[Supabase][https://supabase.com/] is an open source alternative to Firebase, Supabase provides a hosted Postgres database that allows you to store and manage your application’s data.
